...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    style.textContent = [
      ...
      ".dsh-ws-discard:hover:not(:disabled){color:var(--dsw-alias-label-primary)}",
      ".dsh-ws-save{background:var(--dsw-alias-brand-primary);color:var(--dsw-alias-brand-primary-invert)}",
      ".dsh-ws-save:hover:not(:disabled){opacity:.88}",
      ".dsh-ws-discard:disabled,.dsh-ws-save:disabled{cursor:default;opacity:.5}",
